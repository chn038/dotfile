...
vim.keymap.set('n', "<leader>sC", ":JupyniumClearSelectedCellsOutputs<cr>", { desc = "clear cell" })
vim.keymap.set('n', "<leader>rr", ":JupyniumKernelRestart<cr>", { desc = "restart kernel" })
vim.keymap.set('n', "<leader>rk", ":JupyniumKernelInterrupt<cr>", { desc = "interrupt" })
vim.keymap.set('n', "<leader>rc", ":JupyniumKernelSelect<cr>", { desc = "select kernel" })
vim.keymap.set('n', "<leader>sk", ":JupyniumKernelHover<cr>", { desc = "show kernel help" })
