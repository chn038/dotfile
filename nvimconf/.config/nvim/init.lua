...
later(function()
    ...
    vim.keymap.set("n", "<leader>d", function() require('mini.visits').remove_label("core") end,
        { desc = "delete label" })
    ...
    vim.keymap.set('n', '<leader>u', require('undotree').toggle, { desc = 'Open undotree', silent = true })
